...
public struct TransformFB : IFlatbufferObject
{
  ...
  public hololensMulti.Vec3? RHPos { get { int o = __p.__offset(10); return o != 0 ? (hololensMulti.Vec3?)(new hololensMulti.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public hololensMulti.Quat? RHRot { get { int o = __p.__offset(12); return o != 0 ? (hololensMulti.Quat?)(new hololensMulti.Quat()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public hololensMulti.Vec3? LHPos { get { int o = __p.__offset(14); return o != 0 ? (hololensMulti.Vec3?)(new hololensMulti.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public hololensMulti.Quat? LHRot { get { int o = __p.__offset(16); return o != 0 ? (hololensMulti.Quat?)(new hololensMulti.Quat()).__assign(o + __p.bb_pos, __p.bb) : null; } }

  public static void StartTransformFB(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static void AddRHPos(FlatBufferBuilder builder, Offset<hololensMulti.Vec3> RHPosOffset) { builder.AddStruct(3, RHPosOffset.Value, 0); }
  public static void AddRHRot(FlatBufferBuilder builder, Offset<hololensMulti.Quat> RHRotOffset) { builder.AddStruct(4, RHRotOffset.Value, 0); }
  public static void AddLHPos(FlatBufferBuilder builder, Offset<hololensMulti.Vec3> LHPosOffset) { builder.AddStruct(5, LHPosOffset.Value, 0); }
  public static void AddLHRot(FlatBufferBuilder builder, Offset<hololensMulti.Quat> LHRotOffset) { builder.AddStruct(6, LHRotOffset.Value, 0); }
