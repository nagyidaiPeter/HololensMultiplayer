...
public struct TransformFB : IFlatbufferObject
{
  ...
  public hololensMulti.Vec3? RHPos { get { int o = __p.__offset(14); return o != 0 ? (hololensMulti.Vec3?)(new hololensMulti.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public hololensMulti.Quat? RHRot { get { int o = __p.__offset(16); return o != 0 ? (hololensMulti.Quat?)(new hololensMulti.Quat()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public bool LHActive { get { int o = __p.__offset(18); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public hololensMulti.Vec3? LHPos { get { int o = __p.__offset(20); return o != 0 ? (hololensMulti.Vec3?)(new hololensMulti.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public hololensMulti.Quat? LHRot { get { int o = __p.__offset(22); return o != 0 ? (hololensMulti.Quat?)(new hololensMulti.Quat()).__assign(o + __p.bb_pos, __p.bb) : null; } }

  public static void StartTransformFB(FlatBufferBuilder builder) { builder.StartTable(10); }
  ...
  public static void AddRHPos(FlatBufferBuilder builder, Offset<hololensMulti.Vec3> RHPosOffset) { builder.AddStruct(5, RHPosOffset.Value, 0); }
  public static void AddRHRot(FlatBufferBuilder builder, Offset<hololensMulti.Quat> RHRotOffset) { builder.AddStruct(6, RHRotOffset.Value, 0); }
  public static void AddLHActive(FlatBufferBuilder builder, bool LHActive) { builder.AddBool(7, LHActive, false); }
  public static void AddLHPos(FlatBufferBuilder builder, Offset<hololensMulti.Vec3> LHPosOffset) { builder.AddStruct(8, LHPosOffset.Value, 0); }
  public static void AddLHRot(FlatBufferBuilder builder, Offset<hololensMulti.Quat> LHRotOffset) { builder.AddStruct(9, LHRotOffset.Value, 0); }
